    ...
    if int(try_1) > int(random_number):
        ...
        if not Winner:
            ...
            if not Winner:
                time.sleep(delay)
                try_3 = input(
                    "This is now your last chance to guess! Choose the number wisely! Enter the number you think it is: ")
                time.sleep(delay)
            ...
            if not Winner:
                ...
                if not Winner:
                    ...
                    if int(try_5) > int(random_number):
                        ...
                        print(
                                "This shouldn't be printed if so then please contact aravgupta2019@gmail.com, THANK YOU!")
